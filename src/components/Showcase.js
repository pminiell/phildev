...
const Showcase = () => {
  return (
    <>
      <div className="bg-gradient-to-br from-indigo-800 via-green-200 to-indigo-900 h-screen bg-fixed">
        <div className="grid justify-items-center">
          <img
            src={data[0].path}
            alt={data[0].title}
            className="rounded-full border border-indigo-900 h-36 w-36 md:h-64 md:w-64 object-cover m-2"
          />
          <h1 className="rounded-full justify-items-center lg:w-1/3 bg-indigo-900 text-white text-m md:text-xl lg:text-2xl text-center font-bold p-2 mb-2">
            Hi , my name is Phil!
          </h1>
          <h1 className="rounded-lg justify-items-center w-2/3 bg-indigo-900 text-white text-m md:text-xl lg:text-2xl text-center p-2 m-2">
          ...
          <div className="w-4/6 m-auto flex flex-row space-x-2 justify-center">
